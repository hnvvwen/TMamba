...
def parse_args():
    ...
    # for train
    parser.add_argument('--script', type=str, default='osmtrack', choices=['osmtrack'],
                        help='training script name')
    parser.add_argument('--config', type=str, default='vim', help='yaml configure file name')
...
if __name__ == "__main__":
    ...
    if args.script == "osmtrack":
        model_module = importlib.import_module('lib.models')
        model_constructor = model_module.build_osmtrack
