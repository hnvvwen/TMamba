...
"""trackingmamba"""
trackers.extend(trackerlist(name='trackingmamba', parameter_name='trackingmamba', dataset_name=dataset_name,
                            run_ids=None, display_name='trackingmamba'))
# trackers.extend(trackerlist(name='osmtrack', parameter_name='vim', dataset_name=dataset_name,
#                             run_ids=None, display_name='OSMTrack384'))
