...
"""
Add default config for TrackingMamba.
"""
cfg = edict()

# MODEL
cfg.MODEL = edict()
cfg.MODEL.PRETRAIN_FILE = "hustvlVim-small-midclstok+/vim_s_midclstok_80p5acc.pth"
...
cfg.MODEL.BACKBONE.TYPE = "vim_small_patch16_224_bimambav2_final_pool_mean_abs_pos_embed_with_midclstok_div2"
...
cfg.TRAIN.EPOCH = 30  #300
cfg.TRAIN.LR_DROP_EPOCH = 240
cfg.TRAIN.BATCH_SIZE = 64  #100
